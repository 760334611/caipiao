...
class MainShuangSeQiuViewModel : ViewModel() {
    var mHistoryTimeList: MutableSharedFlow<ArrayList<HistoryRecord>> =
        MutableSharedFlow()
    var mHistoryPrizeList: MutableSharedFlow<ArrayList<HistoryPrizeNumber>> =
        MutableSharedFlow()
     ...
     * 历史开奖记录
     */
    private var mHistoryPrizeNumberList = ArrayList<HistoryPrizeNumber>()

    @SuppressLint("SimpleDateFormat")
    private var dateFormat: SimpleDateFormat = SimpleDateFormat("yyyy-mm-dd")

    fun getHistoryPrizeData() {
     ...
     * 自选历史号码
     */
    fun getHistorySelectList() = mHistorySelectList

    /**
     * 历史开奖号码
     */
    fun getHistoryPrizeNumberList() = mHistoryPrizeNumberList

    fun insertHistoryData(selectNumberList: ArrayList<SelectNumber>) {
        viewModelScope.launch {
